            ...
            <div class=" ml-6 flex flex-wrap justify-center">
                ...
                <div class=" px-1 w-full flex flex-col p-6 sm:w-1/2 lg:w-1/3">
                    <a href="/product/{{$product->id}}">
                        <section class="w-72 h-96 shadowHighlighted rounded-xl">
                            ...
                            <section class="relative px-4 h-44">
                                ...
                                <div class="block pb-1 h-9 overflow-auto">
                                    ...
                                    @if(auth()->id() == $artisan->user_id)
                                        <div class="relative">
                                            ...
                                            <div class="absolute bottom-0 right-0"> 
                                                <p class=" beigeAmaso pl-2 productDescription">Stock: {{$product->stock}}</p>
                                            </div>
                                            @endif
                                        </div>
                                    @endif
